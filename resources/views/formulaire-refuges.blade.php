...
<head>
    ...
    <title>Formulaire de refuges</title>
...
<div class="container mx-auto px-4 mt-20">
    <header class="mb-4">
        <h1 class="text-3xl font-bold">Faire ajouter son refuge</h1>
    </header>
    ...
    <?php endif; ?>
    <form action="{{ route('refuge_requests.store') }}" method="POST" class="bg-gray-100 text-black p-6 rounded shadow-md">
        @csrf
        <div class="mb-4">
            <label for="nom_refuge" class="block text-sm font-bold mb-2">Nom du refuge:</label>
            <input type="text" name="nom_refuge" id="nom_refuge" class="border rounded w-full py-2 px-3" required>
            @error('nom_refuge')
            <span class="text-red-500 text-xs">{{ $message }}</span>
            @enderror
        </div>
        <div class="mb-4">
            <label for="adresse_refuge" class="block text-sm font-bold mb-2">Adresse:</label>
            <input type="text" name="adresse_refuge" id="adresse_refuge" class="border rounded w-full py-2 px-3" required>
            @error('adresse_refuge')
            <span class="text-red-500 text-xs">{{ $message }}</span>
            @enderror
        </div>
        <div class="mb-4">
            <label for="numero_refuge" class="block text-sm font-bold mb-2">Numéro de téléphone:</label>
            <input type="text" name="numero_refuge" id="numero_refuge" class="border rounded w-full py-2 px-3" required>
            @error('numero_refuge')
            <span class="text-red-500 text-xs">{{ $message }}</span>
            @enderror
        </div>
        <div class="mb-4">
            <label for="site_web_refuge" class="block text-sm font-bold mb-2">Site web (facultatif):</label>
            <input type="text" name="site_web_refuge" id="site_web_refuge" class="border rounded w-full py-2 px-3">
            @error('site_web_refuge')
            <span class="text-red-500 text-xs">{{ $message }}</span>
            @enderror
        </div>
