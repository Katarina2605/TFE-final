    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-3">
            <div class="flex items-center">
                <a class="ml-4" href="/">
                    <img src="https://images2.imgbox.com/38/6e/bu3CxlUw_o.png" alt="Respons'adopt logo" class="h-12">
                </a>
            </div>
    ...
    <div id="mc_embed_shell">
        ...
        <style type="text/css">
            #mc_embed_signup {
                ...
                padding: 10px; /* Ajouter un padding pour l'espace intérieur */
                border-radius: 8px; /* Ajouter une bordure arrondie */
                box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); /* Ajouter une ombre */
            }
        </style>
        <div id="mc_embed_signup" class="bg-white p-6 rounded-lg shadow-lg" style="width: 100%;">
            <form action="https://katarina-gerlage.us13.list-manage.com/subscribe/post?u=11be1adeb061bb434cb0d2389&amp;id=d906b81835&amp;f_id=00d388eaf0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
                <div id="mc_embed_signup_scroll">
                    <h2 class="text-center text-2xl font-bold text-gray-800 mb-4 font-sans">Newsletter - Respons'adopt</h2>
                    <div class="indicates-required"><span class="asterisk">*</span> Champ obligatoire</div>
                    <div class="mc-field-group"><label for="mce-EMAIL">Adresse e-mail <span class="asterisk">*</span></label><input type="email" name="EMAIL" class="required email w-full px-3 py-2 border rounded-md shadow-sm" id="mce-EMAIL" required="" value=""></div><div class="mc-field-group"><label for="mce-FNAME">Prénom <span class="asterisk">*</span></label><input type="text" name="FNAME" class="required text w-full px-3 py-2 border rounded-md shadow-sm" id="mce-FNAME" required="" value=""></div><div class="mc-field-group"><label for="mce-LNAME">Nom de famille <span class="asterisk">*</span></label><input type="text" name="LNAME" class="required text w-full px-3 py-2 border rounded-md shadow-sm" id="mce-LNAME" required="" value=""></div>
                    ...
                    <div class="optionalParent">
                        <div class="clear foot">
                            <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button w-full mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md shadow-md" value="S'abonner">
                            <p style="margin: 0px auto;"><a href="http://eepurl.com/iSpmgA" title="Avec Mailchimp, les campagnes de marketing par e-mail sont un jeu d'enfant"><span style="display: inline-block; background-color: transparent; border-radius: 4px;"><img class="refferal_badge" src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/intuit-mc-rewards-text-dark.svg" alt="Intuit&nbsp;Mailchimp" style="width: 220px; height: 40px; display: flex; padding: 2px 0px; justify-content: center; align-items: center;"></span></a></p>
                        </div>
                    </div>
                </div>
            </form>
