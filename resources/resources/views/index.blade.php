        ...
        <div class="flex flex-wrap mt-8">
            ...
            <div class="w-full md:w-1/4 p-4 flex-grow">
                <div class="bg-white shadow-md rounded-md p-6 text-center h-full">
                    ...
                    <p class="mt-2">Un animal est un engagement qui durera le long de sa vie mais qui vous apportera bonheur et amour.</p>
                </div>
            </div>
            <div class="w-full md:w-1/4 p-4 flex-grow">
                <div class="bg-white shadow-md rounded-md p-6 text-center h-full">
                    ...
                    <h4 class="font-semibold">Venez adopter</h4>
                    <p class="mt-2">Nôtre but, vous trouver un petit compagnon. Contactez-nous pour l'adopter.</p>
                </div>
            </div>
        </div> <!-- /row  -->
    </div>
...
<div class="container mx-auto py-8">
    <h3 class="text-center text-2xl font-semibold">Questions fréquentes</h3>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        @if($faqs->isEmpty())
            <p class="text-center">Aucune FAQ trouvée.</p>
        @else
            @foreach($faqs as $faq)
                <div class="bg-white shadow-md rounded-md p-6">
                    <h3 class="text-xl font-semibold text-blue-800 mb-2">{{ $faq->question }}</h3>
